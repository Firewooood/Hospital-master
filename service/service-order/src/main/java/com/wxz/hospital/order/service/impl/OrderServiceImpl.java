...
import com.wxz.client.user.PatientFeignClient;
import com.wxz.common.rabbit.constant.MqConst;
import com.wxz.common.rabbit.service.RabbitService;
...
import com.wxz.hospital.order.mapper.OrderMapper;
...
import com.wxz.hospital.vo.order.OrderMqVo;
...
//            短信提示
    ...
    public IPage<OrderInfo> selectPage(Page<OrderInfo> pageParam, OrderQueryVo orderQueryVo) {
        ...
        Long patientId = orderQueryVo.getPatientId(); //就诊人名称(用id查)
