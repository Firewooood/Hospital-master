...
import com.wxz.hospital.user.util.ConstantWxPropertiesUtils;
import com.wxz.hospital.user.util.HttpClientUtils;
...
//微信操作的接口
@Controller //这里为了方便跳转 而不需要传回json数据 可以不用那个
