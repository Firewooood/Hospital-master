        ...
        <div>
          ...
          <div class="content-wrapper">
            <el-form :model="patient" label-width="110px" label-position="left" ref="patient" :rules="validateRules">
              ...
              <el-form-item prop="email" label="邮箱号码：">
                <el-input v-model="patient.email" placeholder="请输入邮箱号码" maxlength="25" class="input v-input" />
              </el-form-item>
            </el-form>
          </div>
          ...
          <div class="content-wrapper">
            <el-form :model="patient" label-width="110px" label-position="left">
              ...
              <el-form-item prop="contactsEmail" label="邮箱号码：">
                <el-input v-model="patient.contactsEmail" placeholder="请输入联系人邮箱号码" class="input v-input" />
              </el-form-item>
            </el-form>
          </div>
        </div>
