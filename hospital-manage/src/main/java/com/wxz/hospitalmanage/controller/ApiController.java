package com.wxz.hospitalmanage.controller;
...
public class ApiController extends BaseController {
	...
	public String saveHospital(String data, HttpServletRequest request) {	// 此处的String data == @RequestParam(value = "userName") String userName
		try {
